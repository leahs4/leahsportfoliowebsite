  ...
  return(
    <div>
      <header className="App-contact">
        ...
        <p class="pls animate__animated animate__zoomIn">Please feel free to connect with me on LinkedIn!</p>
        ...
        <p class="inq animate__animated animate__zoomIn">For any inquiries please email me:</p>
